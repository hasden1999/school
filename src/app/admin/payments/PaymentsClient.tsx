        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <select
              ...
              className="w-full md:w-auto px-4 py-2.5 rounded-xl border border-slate-300 text-xs font-bold text-slate-800 bg-white outline-none focus:border-brand-600 focus:ring-1 focus:ring-brand-600 cursor-pointer"
            >
