      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-between">
          <div>
            ...
            <span className="text-lg font-black text-slate-900">{students.length} طالب</span>
          </div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-between">
          <div>
            <span className="text-[11px] font-bold text-emerald-600 block">حاضرون اليوم</span>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-between">
          <div>
            <span className="text-[11px] font-bold text-rose-600 block">غائبون</span>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-between">
          <div>
            <span className="text-[11px] font-bold text-purple-600 block">مجازون / متأخرون</span>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
            ...
            <div>
              ...
              <select
                ...
                className="px-3.5 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-800 bg-white"
              >
                {classRooms.map((c) => (
            ...
            >
              ...
              <div>
                ...
                <span className="text-[10px] opacity-80">
                  {dateStr > new Date().toISOString().split("T")[0]
                    ? "⚠️ لم يتم أخذ الحضور لهذا اليوم (تاريخ مستقبلي)"
                    : dateStr < new Date().toISOString().split("T")[0]
